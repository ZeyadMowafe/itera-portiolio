  ...
  return (
    <div ref={wrapperRef} className="fb-wrapper">
      ...
      >
        ...
        {/* Chevron ghost — dim echo floating up */}
        <svg ref={sttGhostRef} className="fb-stt-ghost" viewBox="0 0 40 28" fill="none">
          <path stroke="rgba(168,85,247,0.2)" strokeWidth="4.5"
            strokeLinecap="round" strokeLinejoin="round"
            d="M4 24 L20 6 L36 24"/>
        </svg>

        {/* Chevron — main draw animation only */}
        <svg className="fb-stt-logo" viewBox="0 0 40 28" fill="none">
          <defs>
            <linearGradient id="stt-logo-g" x1="0%" y1="100%" x2="0%" y2="0%">
              <stop offset="0%"   stopColor="#4F46E5"/>
              <stop offset="50%"  stopColor="#7C3AED"/>
              <stop offset="100%" stopColor="#A855F7"/>
            </linearGradient>
          ...
          <path
            ref={sttPath1Ref}
            className="fb-stt-path fb-stt-path--1"
            strokeLinecap="round" strokeLinejoin="round"
            d="M4 24 L20 6"
          />
          {/* right arm */}
          <path
            ref={sttPath2Ref}
            className="fb-stt-path fb-stt-path--2"
            strokeLinecap="round" strokeLinejoin="round"
            d="M20 6 L36 24"
          />
        </svg>
